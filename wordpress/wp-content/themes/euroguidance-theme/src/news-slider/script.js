...
export function initNewsSlider(root, opts = {}) {
  ...
  new Swiper(sliderEl, {
    ...
    navigation: {
      nextEl: container.querySelector('.ntd-news-carousel__nav.is-next'),
      prevEl: container.querySelector('.ntd-news-carousel__nav.is-prev'),
    },
    breakpoints: {
      0:    { slidesPerView: 1 },
      768:  { slidesPerView: 2 },
