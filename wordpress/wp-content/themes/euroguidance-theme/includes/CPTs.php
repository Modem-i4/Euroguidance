...
add_action('init', function () {
  ...
  foreach ($people_types as $type => $cfg) {
    register_post_type($type, [
      ...
      'menu_icon'    => $cfg['icon'],
      'template' => [ [ 'core/columns', [], [ [ 'core/column', [ 'width' => '300px' ], [ [ 'core/post-featured-image', [ 'style' => [ 'border' => [ 'radius' => '0px' ] ] ] ], ]], [ 'core/column', [], [ [ 'core/post-title', [] ], [ 'core/separator', [] ], [ 'core/paragraph', [ 'content' => 'Ваш короткий опис', 'placeholder' => 'Ваш короткий опис' ] ], ]], ]], [ 'core/heading', [ 'textAlign' => 'center', 'level' => 1, 'content' => '<strong>Сертифікація та кваліфікація</strong>' ] ], [ 'parts-blocks/bullet-meta-list', [ 'metaKey' => 'qual', 'className' => 'checks-list green-checks' ] ], [ 'core/heading', [ 'textAlign' => 'center', 'level' => 1, 'content' => 'Спеціалізації' ] ], [ 'parts-blocks/bullet-meta-list', [ 'metaKey' => 'spec', 'className' => 'checks-list blue-checks' ] ], [ 'core/heading', [ 'textAlign' => 'center', 'level' => 1, 'content' => 'Досвід' ] ], [ 'parts-blocks/bullet-meta-list', [ 'metaKey' => 'exp' ] ], [ 'core/heading', [ 'textAlign' => 'center', 'level' => 1, 'content' => 'Контакти' ] ], [ 'core/group', [ 'style'  => [ 'spacing' => [ 'blockGap' => 'var:preset|spacing|50' ] ], 'layout' => [ 'type' => 'flex', 'flexWrap' => 'nowrap', 'justifyContent' => 'center' ], ], [ [ 'core/media-text', [ 'mediaWidth' => 15, 'isStackedOnMobile' => false, 'imageFill' => false, 'mediaType' => 'image', 'mediaUrl' => get_template_directory_uri() . '/assets/icons/email.svg', ], [ [ 'core/paragraph', [ 'content' => 'email', 'placeholder' => 'Вміст…', 'metadata' => [ 'bindings' => [ 'content' => [ 'source' => 'core/post-meta', 'args' => [ 'key' => 'email' ], ], ], ], ]], ] ], [ 'core/media-text', [ 'mediaWidth' => 15, 'isStackedOnMobile' => false, 'imageFill' => false, 'mediaType' => 'image', 'mediaUrl' => get_template_directory_uri() . '/assets/icons/phone.svg', ], [ [ 'core/paragraph', [ 'content' => 'телефон', 'placeholder' => 'Вміст…', 'metadata' => [ 'bindings' => [ 'content' => [ 'source' => 'core/post-meta', 'args' => [ 'key' => 'phone' ], ], ], ], ]], ] ], ] ], ],
    ]);
